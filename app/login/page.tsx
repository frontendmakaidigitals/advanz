...
import BgLayer from "../(user)/components/BgLayer";
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-gray-100 px-4">
      ...
      >
        ...
        <Button
          className="w-full flex justify-center mt-10 bg-yellow-600 hover:bg-dimondra-tealDark hover:text-dimondra-white"
          type="submit"
        >
          Login
        </Button>
