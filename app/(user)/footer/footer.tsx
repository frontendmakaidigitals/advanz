...
const Footer = () => {
  return (
    <footer className="footer relative bg-[#16151A] text-white px-6 md:px-20 py-20 overflow-hidden">
      ...
      {/* Top divider */}
      <div className="origin-left h-[2px] w-full bg-gradient-to-r from-yellow-500 via-yellow-400/50 to-transparent mb-20 relative" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              {[
                { label: "Workshop Services", href: "/service/workshop" },
                { label: "Body Shop Services", href: "/service/body-shop" },
                { label: "Spare Parts", href: "/service/spare-parts" },
                {
                  label: "Car Key Programming",
                  href: "/service/car-programming",
                },
                {
                  label: "Recovery & Assistance",
                  href: "/service/recovery-service",
                },
              ].map((item) => (
                <li
                  key={item.label}
                  className="hover:text-yellow-400 flex items-center gap-1 transition-colors cursor-pointer hover:translate-x-1 transform duration-200"
                >
